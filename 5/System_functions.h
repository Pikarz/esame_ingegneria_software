...
static const MMC_DEFSTRUCTLIT(boxvar_lit_simulate__wind,2,0) {(void*) boxptr_simulate__wind,0}};
#define boxvar_simulate__wind MMC_REFSTRUCTLIT(boxvar_lit_simulate__wind)
