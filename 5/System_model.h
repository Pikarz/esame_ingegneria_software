...
#define myrandom_index 0
#define simulate__wind_index 1
#define Modelica_Utilities_Files_fullPathName_index 2
#define Modelica_Utilities_Files_remove_index 3
#define Modelica_Utilities_Files_remove_removeDirectory_index 4
#define Modelica_Utilities_Files_remove_removeDirectoryContents_index 5
#define Modelica_Utilities_Internal_FileSystem_getNumberOfFiles_index 6
#define Modelica_Utilities_Internal_FileSystem_readDirectory_index 7
#define Modelica_Utilities_Internal_FileSystem_removeFile_index 8
#define Modelica_Utilities_Internal_FileSystem_rmdir_index 9
#define Modelica_Utilities_Internal_FileSystem_stat_index 10
#define Modelica_Utilities_Streams_print_index 11
#define Modelica_Utilities_Strings_length_index 12
#define Modelica_Utilities_Strings_substring_index 13
